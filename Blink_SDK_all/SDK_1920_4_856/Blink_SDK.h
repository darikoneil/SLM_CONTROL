...
public:
  ...
  /// @param flip_immediate      If supported by hardware, this allows image to flip w/o delay
  ...
  // -------------------------------------------------------------------------
  // Channel balancing 1k ONLY
  // -------------------------------------------------------------------------
  /// 
  // -------------------------------------------------------------------------
  bool SetDACTestMode(int board, bool enableTestMode);

  bool SetDACTestValue(int board, int DACValue);

  bool GetDACVals(int board, int* DACValues);
