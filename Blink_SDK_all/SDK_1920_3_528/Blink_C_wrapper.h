...
extern "C" { /* using a C++ compiler */
  ...
  BLINK_C_WRAPPER_API int Load_LUT_Arrays(int board, const unsigned short* RampUp, const unsigned short* RampDown, const unsigned short* PreRampUp, const unsigned short* PreRampDown);
