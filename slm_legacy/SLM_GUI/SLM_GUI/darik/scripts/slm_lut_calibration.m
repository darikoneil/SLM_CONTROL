...
%% PARAMETERS
fname_lut = [];
path1 = 'C:\Users\rylab_901c_slm\PycharmProjects\split_slm\mlb\SLM_GUI\SLM_outputs\lut_calibration\';
save_tag = [fname_lut '_corr'];
params.two_photon = 1; % is intensity 2p? since 2pFl ~ I^2, will take sqrt
